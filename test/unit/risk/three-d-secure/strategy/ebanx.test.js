...
describe('EbanxStrategy', function () {
  ...
  describe('redirectUrl', function () {
    it('returns the redirect URL from the action token params', function () {
      const { strategy } = this;
      assert.strictEqual(strategy.redirectUrl, 'https://3dsecure.ebanx.com/challenge/test-redirect-url');
    });
  });
