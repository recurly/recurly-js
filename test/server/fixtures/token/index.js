...
var DECLINED_TAX_IDENTIFIER_TYPE = 'Tax identifier type must be one of the following: ["cpf", "cuit"]';
...
module.exports = function token () {
  ...
  if (params.tax_identifier_type && !~['cpf', 'cuit'].indexOf(params.tax_identifier_type)) return invalidTaxIdentifierType;
  else return ok;
};
