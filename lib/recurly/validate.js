...
const TYPES = [
  {
    ...
    pattern: {
      test: (n) => {
        let firstEight = parseInt(n.substr(0, 8), 10);
        let accepted_ranges = [
          [60110000,60110399],
          [60110500,60110999],
          [60112000,60114999],
        ...
        return accepted_ranges.indexOf(([minimum, maximum]) => firstEight >= minimum && firstEight <= maximum) !== undefined;
      }
    },
    lengths: [16, 17, 18, 19]
  },
