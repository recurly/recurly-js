...
export default class Calculations {
  ...
  taxes () {
    ...
    const getTaxesFor = item => getTaxesPromise(Object.assign({}, baseTaxInfo, { taxCode: item.taxCode }));
    ...
    return Promise.all(this.taxableAdjustments.map(adj => {
      ...
      .then(() => {
        ...
        return getTaxesPromise(baseTaxInfo).then(taxes => {
          taxes.forEach(tax => {
