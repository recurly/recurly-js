...
export default class Calculations {
  ...
  discount () {
    ...
    if (coupon.discount.rate) {
      ...
      this.price.now.discount = Math.min(this.price.now.subtotal, coupon.discount.amount[this.items.currency]);
      this.price.next.discount = Math.min(this.price.next.subtotal, coupon.discount.amount[this.items.currency]);
    }
