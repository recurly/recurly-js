...
const ERRORS = [
  ...
  },
  {
    ...
    message: c => `An error occurred while attempting to obtain a fingerprint for ${c.gateway}.
                         Please refer to the cause property for more defail.`,
    classification: 'internal'
  },
  {
    code: '3ds-challenge-error',
    message: c => `An error occurred while attempting to obtain a challenge result for ${c.gateway}.
                         Please refer to the cause property for more defail.`,
    classification: 'internal'
  },
  {
