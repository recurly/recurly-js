...
const ERRORS = [
  ...
  {
    code: '3ds-vendor-auth-error',
    message: c => `An error occurred while attempting to obtain 3D Secure authorization for
                   ${c.gateway}. Please refer to the cause property for more defail.`,
    classification: 'internal'
  },
  {
