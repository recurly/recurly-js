...
const ERRORS = [
  ...
  },
  {
    ...
    message: vendor => `An error occurred while loading a dependency from ${vendor}. Please refer
                        to the cause property for more detail.`,
    classification: 'internal'
  },
  {
    code: '3ds-fingerprint-error',
    message: gateway => `An error occurred while attempting to obtain a fingerprint for ${gateway}.
                         Please refer to the cause property for more defail.`,
    classification: 'internal'
  },
  {
    code: '3ds-challenge-error',
    message: gateway => `An error occurred while attempting to obtain a challenge result for ${gateway}.
                         Please refer to the cause property for more defail.`,
    classification: 'internal'
  },
  {
