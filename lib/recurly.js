...
const XHR = require('cors-xhr');
const Emitter = require('emitter');
const errors = require('./errors');
const version = require('./version');
const debug = require('debug')('recurly');

const Bus = require('./recurly/bus');
...
Recurly.prototype.initParent = function (options) {
  ...
  // TODO: The bus needs to become an emitter...
  this.hostedFields.once('hostedFields:ready', body => { this.bus.send({ event: 'hostedFields:ready', body: body }); });
};
...
Recurly.prototype.HostedFields = require('./recurly/hosted-fields');
