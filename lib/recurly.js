...
import {Pricing} from './recurly/pricing/index';
...
export class Recurly extends Emitter {
  ...
  parent (options) {
    ...
    this.hostedFields.on('hostedFields:state:change', (body) => {
      this.emit('change', { fields: body });
    });
...
Recurly.prototype.Pricing = Pricing;
