...
export default class Recurly extends Emitter {
  constructor (options) {
    super();
    this.id = uuid();
    ...
    this.Pricing.Checkout = CheckoutPricing;
    this.Pricing.Subscription = SubscriptionPricing;
  }
  ...
  /**
   * Old method of instantiating single-subscription Pricing
   *
   * @deprecated
   */
  Pricing () {
    return new SubscriptionPricing(this);
  }
}
