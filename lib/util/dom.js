...
/**
 * Utility function to determine if an input is intended to be hidden
 * @return {Boolean}
 */

function isHiddenInput (element = undefined) {
  return element !== undefined && element.style !== undefined && element.style.opacity === '0';
}
