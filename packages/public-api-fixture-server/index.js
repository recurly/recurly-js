...
app.use(route.get('/bank_redirect/start', postMessage));
...
app.use(route.get('/google_pay/info', json));
app.use(route.get('/payment_methods/list', json));
app.use(route.post('/payment_methods/token', json));
...
app.use(route.get('/risk/data_collector', postMessage));
app.use(route.get('/tax', json));
app.use(route.get('/test', json));
app.use(route.post('/test', json));
app.use(route.put('/test', json));
